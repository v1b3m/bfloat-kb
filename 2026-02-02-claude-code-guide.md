# Thread by @bcherny on Thread Reader App – Thread Reader App
[![Boris Cherny Profile picture](https://pbs.twimg.com/profile_images/1902044548936953856/J2jeik0t_bigger.jpg)](/user/bcherny)
...
See [code.claude.com/docs/en/common…](https://code.claude.com/docs/en/common-workflows#run-parallel-claude-code-sessions-with-git-worktrees)
[![Image](https://threadreaderapp.com/images/1px.png)](https://pbs.twimg.com/media/HABmmP6bwAAWgUM.jpg)
...
Another says the moment something goes sideways, they switch back to plan mode and re-plan. Don't keep pushing. They also explicitly tell Claude to enter plan mode for verification steps, not just for the build[![Image](https://threadreaderapp.com/images/1px.png)](https://pbs.twimg.com/media/HABm-MtbEAAMlsS.png)

3\. Invest in your [CLAUDE.md](http://claude.md/). After every correction, end with: "Update your [CLAUDE.md](http://claude.md/) so you don't make that mistake again." Claude is eerily good at writing rules for itself.

Ruthlessly edit your [CLAUDE.md](http://claude.md/) over time. Keep iterating until Claude's mistake rate measurably drops.

One engineer tells Claude to maintain a notes directory for every task/project, updated after every PR. They then point [CLAUDE.md](http://claude.md/) at it.[![Image](https://threadreaderapp.com/images/1px.png)](https://pbs.twimg.com/media/HABoHn9bQAAE-S1.png)
...
Learn more: [code.claude.com/docs/en/skills…](https://code.claude.com/docs/en/skills#extend-claude-with-skills)
...
Point Claude at docker logs to troubleshoot distributed systems -- it's surprisingly capable at this.[![Image](https://threadreaderapp.com/images/1px.png)](https://pbs.twimg.com/media/HABy6cObEAQ4Rep.png)
...
More tips: [code.claude.com/docs/en/termin…](https://code.claude.com/docs/en/terminal-config)
[![Image](https://threadreaderapp.com/images/1px.png)](https://pbs.twimg.com/media/HABpv-MbEAAIskz.jpg)
...
c. Route permission requests to Opus 4.5 via a hook — let it scan for attacks and auto-approve the safe ones (see [code.claude.com/docs/en/hooks#…](https://code.claude.com/docs/en/hooks#permissionrequest))
[![Image](https://threadreaderapp.com/images/1px.png)](https://pbs.twimg.com/media/HAB0KLmbEAEfDJ6.png)
